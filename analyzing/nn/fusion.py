...
from analyzing.layer import Layer
from analyzing.utils.cloud_utils import make_bev_color, make_bev_height_intensity, make_front_proj
from torchvision.models.feature_extraction import create_feature_extractor, get_graph_node_names
from analyzing.utils.cloud_utils import np_to_o3d_cloud
import torchvision.models as models

from analyzing.utils.math import block_mean
...
class BevImageFusion(nn.Module):
    ...
    def forward(self, cloud: np.array, image: np.array):
        ...
        fused_base = np.reshape(fused_base, (fused_base.shape[2], fused_base.shape[1], fused_base.shape[0]))
        bev_fused = fused_base + fused_detail
...
class FrontImageFusion(nn.Module):
    ...
    def forward(self, cloud, image_):
        ...
        fused_base = np.reshape(fused_base, (fused_base.shape[2], fused_base.shape[1], fused_base.shape[0]))
        front_fused = fused_base + fused_detail
