...
def generate_launch_description():
    ...
    package_sim = "lidar_simulator"
    pkg_gazebo_ros = FindPackageShare(package='gazebo_ros').find('gazebo_ros')
    pkg_share = FindPackageShare(package=package_sim).find(package_sim)
    default_launch_dir = "/home/biblbrox/Projects/DeepLabFusionSegmentation/inference"
    default_model_path = os.path.join(pkg_share, 'models/basic_mobile_bot_v2.urdf')
    robot_localization_file_path = os.path.join(pkg_share, 'config/ekf.yaml')
    robot_name_in_urdf = package_sim
